...
<html lang="pt_BR">
  <head>
    <title>FAPI - Notas Oficiais</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <section>
      <div class="container" id="container">
          ...
          <div class="col-md-12">
            ...
            <!-- Início de Notas Oficiais -->
            <?php if($notas['id_nota'] != "") {?>
            <div class="accordion" id="conteudoNotas">
                
            </div>
            <?php } ?>
            <!-- Fim de Notas Oficiais -->
          </div>
      </div>
    </section>
