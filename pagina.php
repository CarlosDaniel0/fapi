<?php
  ...
  // Verifica se existe algum nome de página na URL
  // Caso não exista retorna para a página inicial
  $nome = filter_input(INPUT_GET, 'nome', FILTER_SANITIZE_STRING);
  if ($nome != $pagina['nome'] || empty($nome)) {
...
<html lang="pt_BR">
  <head>
    <title><?php echo "FAPI - " . $pagina['titulo'] ?></title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-xl navbar-light bg-white container container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown <?php if ($pagina['nome'] == 'estatuto' || $pagina['nome'] == 'diretoria' || $pagina['nome'] == 'historia' || $pagina['nome'] == 'regimento-de-taxas' || $pagina['nome'] == 'comissao-cientifica' || $pagina['nome'] == 'transparencia' ) echo 'active' ?>">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                <a class="dropdown-item <?php if ($pagina['nome'] == 'estatuto') echo 'active' ?>" href="pagina?nome=estatuto">ESTATUTO</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'diretoria') echo 'active' ?>" href="pagina?nome=diretoria">DIRETORIA</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'historia') echo 'active' ?>" href="pagina?nome=historia">HISTÓRIA</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'regimento-de-taxas') echo 'active' ?>" href="pagina?nome=regimento-de-taxas">REGIMENTO DE TAXAS</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'comissao-cientifica') echo 'active' ?>" href="pagina?nome=comissao-cientifica">COMISSÃO CIENTÍFICA</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'transparencia') echo 'active' ?>" href="pagina?nome=transparencia">TRANSPARÊNCIA</a>
              </div>
            </li>
            <li class="nav-item dropdown <?php if ($pagina['nome'] == 'filie-se') echo 'active' ?>">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                ...
                <a class="dropdown-item <?php if ($pagina['nome'] == 'filie-se') echo 'active' ?>" href="pagina?nome=filie-se" >FILIE-SE</a>
            ...
            <li class="nav-item dropdown <?php if ($pagina['nome'] == 'regras-de-arbitragem' || $pagina['nome'] == 'documentos-gerais') echo 'active' ?>">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                ...
                <a class="dropdown-item <?php if ($pagina['nome'] == 'regras-de-arbitragem') echo 'active' ?>" href="pagina?nome=regras-de-arbitragem">REGRAS DE ARBITRAGEM</a>
                <a class="dropdown-item <?php if ($pagina['nome'] == 'documentos-gerais') echo 'active' ?>" href="pagina?nome=documentos-gerais">DOCUMENTOS GERAIS</a>
            ...
            <li class="nav-item dropdown <?php if ($pagina['nome'] == 'documentos') echo 'active' ?>">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                ...
                <a class="dropdown-item <?php if ($pagina['nome'] == 'documentos') echo 'active' ?>" href="pagina?nome=documentos">DOCUMENTOS</a>
                <hr>
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
          <h2 style="text-align: center"><?php echo $pagina['titulo'] ?></h2>
          <div class="conteudo">
          <?php if ($pagina['nome'] == $nome): 
            echo $pagina['pagina']; // Conteúdo da pagina
          endif;
          ?>
          </div>
        </div>
