              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h6 class="h6 text-danger mb-4">Acesso Restrito*</h6>
                  </div>
                  <?php 
                  ...
                  <form class="user" method="POST" id="login" action="../vendor/admin/login.php">
                    ...
                    <a href="index.html" name="btnLogin" onClick="document.getElementById('login').submit(); return false;" class="btn btn-primary btn-user btn-block">
                      Entrar
                    </a>
                  </form>
                  </div>
