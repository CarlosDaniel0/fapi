...
<head>
  ...
  <title>Administrativo FAPI - Atletas Filiados</title>
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="atletas-filiados">Atletas Filiados</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="mt-4 mb-4">
          <h3 class="text-gray-900" style="text-align: center;">Atletas Filiados</h3>
        </div>
        <?php 
        ...
        <table class="table tabela-editavel">
          ...
          <tbody>
            <?php 
              ...
              $result_tabela = "SELECT * FROM atletas LIMIT $inicio, $quantidade_resultados";
            ...
            <tr>
              ...
              <td <?php echo "data-id=". $row_tabela['id'] . " data-col=sexo" ?>><?php echo $row_tabela['sexo']?></td>
              <td <?php echo "data-id=". $row_tabela['id'] . " data-col=equipe" ?>><?php echo $row_tabela['equipe']?></td>
              <td <?php echo "data-id=". $row_tabela['id'] . " data-col=idade" ?>><?php echo $row_tabela['idade']?></td>
              <th>
                <div class="row">
        ...
        <div class="row mt-4 d-flex justify-content-center">
          <nav aria-label="Navegação de página exemplo">
            <ul class="pagination">
        <?php 
          $result_pg = "SELECT COUNT(id) AS num_result FROM atletas";
          ...
          for($pag_ant = $pagina - $maximo_links; $pag_ant <= $pagina - 1; $pag_ant++):   
            if ($pag_ant >= 1) :
        ?>
            <li class="page-item"><a class='page-link' href='<?php echo "atletas-filiados?pagina=$pag_ant" ?>'><?php echo "$pag_ant" ?></a></li>
        <?php 
            endif;
          endfor;
        ...
        ?>
            <li class="page-item"><a class='page-link' href='<?php echo "atletas-filiados?pagina=$pag_dep" ?>'><?php echo "$pag_dep" ?></a></li>
        <?php 
            endif;
          endfor;
        ?>
              ...
              <div class="modal-body">
                <form action="../vendor/admin/cadastro_tabela" id="cadastro_tabela" method="post">
                  <div class="col-md-8" style="margin: auto;">
                    ...
                    <div class="col">
                      Equipe
                      <input class="col" name="equipe" type="text" placeholder="Equipe">
                    </div>
                    <div class="col">
                      Idade
                      <input class="col" name="idade" type="number" placeholder="Idade">
                    </div>
                  </div>
              </div>
