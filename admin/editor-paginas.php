        ...
        <div class="container-fluid">
          ...
          ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Página cadastrada com sucesso!</strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
          ...
          <form method="POST" id="editor" action="../vendor/admin/cadastro_pagina.php">
            ...
            <div class="form-group">
              ...
              <input type="text" name="titulo" value="<?php if (isset($pagina['titulo'])) echo $pagina['titulo']?>"
                class="form-control" id="" aria-describedby="helpId" placeholder="">
            </div>
            <label for="texto" class="mt-4">Conteúdo</label></br>
            <textarea name="pagina" id="texto">
              <?php if(isset($pagina['pagina'])) echo $pagina['pagina'];?>
            </textarea><br/>
