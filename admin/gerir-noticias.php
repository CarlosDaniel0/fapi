    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="tabela.html">
          ...
          <span>Gerir Tabelas</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="envio-de-arquivos.html">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <form action="">
            <h3 class="text-gray-900">Editor</h3>
            ...
            <label for="texto" class="mt-4">Conteúdo</label>
            <textarea name="texto" id="texto">

            </textarea>

            <label for="inputState" class="mt-4">Página de Destino</label>
            <select id="inputState" class="form-control">
              <option selected>Selecione...</option>
              <option>...</option>
            </select>

            <input type="submit" class="btn btn-primary mt-4 justify-center" value="Cadastrar">
          </form>
        </div>
      <!-- End of Main Content -->
