      ...
      <div class="col-md-12" style="margin: auto;">
        ...
        <div class="col">
          ...
          <select name="tipo" class="form-control" id="tipo">
            ...
            <option value="Fesporte">Fesporte</option>
          </select>
        </div>
        ${bodyUpdate}
      </div>
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="recordes">Recordes</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="mt-4 mb-4">
          <h3 class="text-gray-900" style="text-align: center;">Recordes</h3>
        </div>
        <?php 
        ...
        <table class="table tabela-editavel">
          ...
          <tbody>
            <?php 
              ...
              $result_tabela = "SELECT * FROM recordes LIMIT $inicio, $quantidade_resultados";
            ...
            <tr>
              ...
              <td <?php echo "data-id=". $row_tabela['id'] . " data-col=data" ?>><?php echo $row_tabela['data']?></td>
              <td <?php echo "data-id=". $row_tabela['id'] . " data-col=tipo" ?>><?php echo $row_tabela['tipo']?></td>
              <th>
                  <?php 
                  if (isset($row_tabela['documento'])): 
                    if($row_tabela['documento'] != ''):
                      $documento = "upload/" . $row_tabela['documento'];
                  ?>
        ...
        <div class="row mt-4 d-flex justify-content-center">
          <nav aria-label="Navegação de página exemplo">
            <ul class="pagination">
        <?php 
          $result_pg = "SELECT COUNT(id) AS num_result FROM recordes";
          ...
          for($pag_ant = $pagina - $maximo_links; $pag_ant <= $pagina - 1; $pag_ant++):   
            if ($pag_ant >= 1) :
        ?>
            <li class="page-item"><a class='page-link' href='<?php echo "recordes?pagina=$pag_ant" ?>'><?php echo "$pag_ant" ?></a></li>
        <?php 
            endif;
          endfor;
        ...
        ?>
            <li class="page-item"><a class='page-link' href='<?php echo "recordes?pagina=$pag_dep" ?>'><?php echo "$pag_dep" ?></a></li>
        <?php 
            endif;
          endfor;
        ?>
