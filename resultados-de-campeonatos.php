...
<html lang="pt_BR">
  <head>
    <title>FAPI - Resultados de Campeonatos</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                ...
                <a class="dropdown-item active" href="resultados-de-campeonatos">RESULTADOS OFICIAIS</a>
              </div>
            </li>
            <li class="nav-item">
   ...
   <section>
      <div class="container">
        <div class="col-md-12">
        <h2 style="text-align: center">Resultados de Campeonatos</h2>

        <div class="form-group col-md-3">
        <label for="select_ano">Ano</label>
        <select class="form-control filtrar" id="select_ano">
          <?php
              $query = "SELECT DISTINCT ano FROM campeonatos";
              $result = mysqli_query($conexao, $query);
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">ESTADUAIS</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">FESTIVAIS</a>
          </li>
          <li class="nav-item" role="presentation">
            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">MARCHA ATLÉTICA</a>
          </li>
        </ul>
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="list-group" id="estaduais">
              
            </div>
          </div>
          <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="list-group" id="festivais">
              
            </div>
          </div>
          <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <div class="list-group" id="marcha_atletica">
    ...
    <script src="js/resultados_campeonatos.js"></script>
  </body>
</html>