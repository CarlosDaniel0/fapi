        ...
        <div class="container">
          ...
          <div class="row d-flex justify-content-center mt-4 mb-4">
            ...
            <div class="col-md-4 d-flex justify-content-center">
              <img class="img img-fluid"src="img/erro.png" alt="Erro 404">
            </div>
          </div>
          <!-- Fim cabeçalho erro -->
          <div class="col d-flex justify-content-center mt-4 mb-4">
            <span> Deseja: <a class="font-weight-bold"href="index">Voltar para o inicio?</a></span>
          </div>
        </div>
        <!-- Fim de Página de Erro -->
    </section>
