...
<html lang="pt_BR">
  <head>
    <title>FAPI - Competições Oficiais</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                <a class="dropdown-item active" href="competicoes-oficiais">LISTA DE COMPETIÇÕES</a>
   ...
   <section>
      <div class="container">
        <?php 
          $query_notas = "SELECT * FROM competicoes";
          $result_notas = mysqli_query($conexao, $query_notas);
          $competicoes = mysqli_fetch_assoc($result_notas);
        ?>
        <div class="col-md-12">
        <h2 style="text-align: center">Competições Oficiais</h2>

        <div class="form-group col-md-3">
        <label for="select_ano">Ano</label>
        <select class="form-control filtrar" id="select_ano">
          <?php
              $query = "SELECT DISTINCT ano FROM competicoes";
        ...
        <!-- Início de Competições Oficiais -->
        <?php if($competicoes['id'] != "") {?>
            <div class="accordion" id="conteudoNotas">
                
            </div>
        <?php } ?>
        <!-- Fim de Competições Oficiais -->
        </div>
      </div>
   </section>
    ...
    <script src="js/script_competicoes.js"></script>
  </body>
</html>