<?php 
    ...
    $query_paginas = "SELECT * FROM corredores";
    ...
    $query_registros = "SELECT * FROM corredores WHERE 1 = 1";
    ...
    if (!empty($requestData['search']['value'])) {
        ...
        $query_registros .= " OR modalidade LIKE '" . $requestData['search']['value'] . "%' )"; 
