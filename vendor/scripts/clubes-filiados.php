<?php 
    ...
    $query_paginas = "SELECT * FROM clubes";
    ...
    $query_registros = "SELECT * FROM clubes WHERE 1 = 1";
    ...
    if (!empty($requestData['search']['value'])) {
        ...
        $query_registros .= " OR telefone LIKE '" . $requestData['search']['value'] . "%' "; 
