...
<html lang="pt_BR">
  <head>
    <title>FAPI - Corredores Oficiais</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                <a class="dropdown-item active" href="corredores-oficiais">LISTA DE CORREDORES</a>
    ...
    <section>
      <div class="container">
          <div class="col-md-12">
            <h2 style="text-align: center">Corredores Oficiais</h2>
