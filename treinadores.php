...
<html lang="pt_BR">
  <head>
    <title>FAPI - Treinadores Filiados</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown active">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownId">
                ...
                <a class="dropdown-item active" href="treinadores">TREINADORES</a>
              </div>
            </li>
            <li class="nav-item dropdown">
    ...
    <section>
      <div class="container">
          <div class="col-md-12">
            <h2 style="text-align: center">Treinadores Filiados</h2>
